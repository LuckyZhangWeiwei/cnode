...
var _initialiseProps = function _initialiseProps() {
  ...
  this.renderSelector = function () {
    ...
    if (showIcon) {
      $icon = icon ? __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(
        'span',
        {
          className: __WEBPACK_IMPORTED_MODULE_6_classnames___default()(prefixCls + '-iconEle', prefixCls + '-icon__customize')
        },
        typeof icon === 'function' ? __WEBPACK_IMPORTED_MODULE_4_react___default.a.createElement(icon, _this2.props) : icon
      ) : _this2.renderIcon();
